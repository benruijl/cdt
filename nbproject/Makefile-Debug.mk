...
${OBJECTDIR}/src/moves/FlipMove.o: src/moves/FlipMove.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -O -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/moves/FlipMove.o src/moves/FlipMove.cpp

${OBJECTDIR}/src/moves/AlexanderMove.o: src/moves/AlexanderMove.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/moves
	${RM} $@.d
	$(COMPILE.cc) -g -O -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/moves/AlexanderMove.o src/moves/AlexanderMove.cpp

${OBJECTDIR}/src/moves/Move.o: src/moves/Move.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/moves
	${RM} $@.d
	$(COMPILE.cc) -g -O -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/moves/Move.o src/moves/Move.cpp

${OBJECTDIR}/src/moves/InversePinchingMove.o: src/moves/InversePinchingMove.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/moves
	${RM} $@.d
	$(COMPILE.cc) -g -O -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/moves/InversePinchingMove.o src/moves/InversePinchingMove.cpp

${OBJECTDIR}/src/moves/InverseAlexanderMove.o: src/moves/InverseAlexanderMove.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/moves
	${RM} $@.d
	$(COMPILE.cc) -g -O -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/moves/InverseAlexanderMove.o src/moves/InverseAlexanderMove.cpp

${OBJECTDIR}/src/moves/PinchingMove.o: src/moves/PinchingMove.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/moves
	${RM} $@.d
	$(COMPILE.cc) -g -O -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/moves/PinchingMove.o src/moves/PinchingMove.cpp

${OBJECTDIR}/src/moves/InverseCollapseMove.o: src/moves/InverseCollapseMove.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/moves
	${RM} $@.d
	$(COMPILE.cc) -g -O -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/moves/InverseCollapseMove.o src/moves/InverseCollapseMove.cpp

${OBJECTDIR}/src/Simulation.o: src/Simulation.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -O -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Simulation.o src/Simulation.cpp

${OBJECTDIR}/src/Utils.o: src/Utils.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -O -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Utils.o src/Utils.cpp

${OBJECTDIR}/src/moves/MoveFactory.o: src/moves/MoveFactory.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/moves
	${RM} $@.d
	$(COMPILE.cc) -g -O -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/moves/MoveFactory.o src/moves/MoveFactory.cpp

${OBJECTDIR}/src/Triangle.o: src/Triangle.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -O -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Triangle.o src/Triangle.cpp

${OBJECTDIR}/src/moves/CollapseMove.o: src/moves/CollapseMove.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/moves
	${RM} $@.d
	$(COMPILE.cc) -g -O -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/moves/CollapseMove.o src/moves/CollapseMove.cpp

${OBJECTDIR}/src/Vertex.o: src/Vertex.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -O -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Vertex.o src/Vertex.cpp
