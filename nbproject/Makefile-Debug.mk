...
${OBJECTDIR}/Triangle.o: Triangle.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -O -MMD -MP -MF $@.d -o ${OBJECTDIR}/Triangle.o Triangle.cpp

${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -O -MMD -MP -MF $@.d -o ${OBJECTDIR}/main.o main.cpp

${OBJECTDIR}/Simulation.o: Simulation.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -O -MMD -MP -MF $@.d -o ${OBJECTDIR}/Simulation.o Simulation.cpp

${OBJECTDIR}/Vertex.o: Vertex.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -O -MMD -MP -MF $@.d -o ${OBJECTDIR}/Vertex.o Vertex.cpp

${OBJECTDIR}/moves/Move.o: moves/Move.cpp 
	${MKDIR} -p ${OBJECTDIR}/moves
	${RM} $@.d
	$(COMPILE.cc) -g -O -MMD -MP -MF $@.d -o ${OBJECTDIR}/moves/Move.o moves/Move.cpp

${OBJECTDIR}/Utils.o: Utils.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -O -MMD -MP -MF $@.d -o ${OBJECTDIR}/Utils.o Utils.cpp
